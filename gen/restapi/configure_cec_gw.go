...
//go:generate swagger generate server --target ../../gen --name CecGw --spec ../../swagger.yaml --principal interface{} --exclude-main

func configureFlags(api *operations.CecGwAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.CecGwAPI) http.Handler {
	...
	if api.PrivateCurrentUserHandler == nil {
		api.PrivateCurrentUserHandler = private.CurrentUserHandlerFunc(func(params private.CurrentUserParams) middleware.Responder {
